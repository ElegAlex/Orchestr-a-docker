...
export const MainLayout: React.FC = () => {
  ...
  // DEBUG: Afficher les informations de permissions
  console.log('🔍 DEBUG MainLayout:', {
    user: user ? { email: user.email, role: user.role, permissions: user.permissions } : 'No user',
    hasAdminAccess: hasAdminAccess(),
    'project.view': hasPermission('project.view' as any),
    'admin.access': hasPermission('admin.access' as any)
  });
