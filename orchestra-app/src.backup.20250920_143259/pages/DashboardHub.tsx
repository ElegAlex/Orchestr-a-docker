...
import CurrentObjectiveWidget from '../components/dashboard/CurrentObjectiveWidget';
  ...
  return (
    <Box sx={{ p: 3 }}>
      ...
      <Box display="flex" flexWrap="wrap" gap={2} mb={4}>
        {/* Widget Objectif Actuel - Prioritaire */}
        <Box sx={{ flex: '1 1 100%', mb: 2 }}>
          <CurrentObjectiveWidget
            projectId={'default'}
            onCreateObjective={() => navigate('/calendar?action=create-objective')}
          />
        </Box>
