...
const CONTRACT_TYPES: { value: ContractType; label: string; color: any }[] = [
  { value: 'CDI', label: 'Contrat à Durée Indéterminée', color: 'success' },
  { value: 'CDD', label: 'Contrat à Durée Déterminée', color: 'warning' },
      ...
      <DialogContent sx={{ px: 0 }}>
        <Box sx={{ borderBottom: 1, borderColor: 'divider', px: 3 }}>
          <Tabs value={tabValue} onChange={(_, value) => setTabValue(value)}>
            ...
            <Tab icon={<BeachAccessIcon />} label="Congés" />
            <Tab icon={<HomeIcon />} label="Télétravail" />
          </Tabs>
        </Box>
        ...
        <TabPanel value={tabValue} index={1}>
          <Box sx={{ p: 3 }}>
            ...
            <Alert severity="info" sx={{ mb: 3 }}>
              Sélectionnez les jours de travail pour cette ressource.
            </Alert>
            ...
            <Box sx={{ display: "flex", gap: 3, flexWrap: "wrap" }}>
              <Box>
                <TextField
                  fullWidth
                  type="number"
                  label="Jours de congés payés annuels"
              ...
              <Box>
                <Alert severity="info">
                  <Typography variant="body2">
                    Les soldes de congés seront automatiquement calculés en fonction de la date d'embauche et des congés déjà pris.
                    Les RTT sont calculés pour les contrats de plus de 35h/semaine.
                  </Typography>
                </Alert>
              </Box>
          ...
          <Box sx={{ p: 3 }}>
            ...
            <Stack spacing={3}>
              <FormControlLabel
                ...
                label="Autoriser le télétravail"
              />
              ...
              {contractForm.isRemoteAllowed && (
                <>
                  <TextField
                    type="number"
                    label="Jours télétravail max par semaine"
                    ...
                    helperText="Nombre maximum de jours en télétravail"
                    sx={{ maxWidth: 300 }}
                  />

                  <Alert severity="info">
                    <Typography variant="body2">
                      Le télétravail sera soumis à validation et planification selon les besoins du service.
                    </Typography>
                  </Alert>
                </>
              )}
