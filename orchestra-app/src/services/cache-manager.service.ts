...
export class CacheManagerService {
  ...
  async clearCorruptedCache(): Promise<boolean> {
    ...
    try {
      ...
      console.log('🧹 Nettoyage du cache Firestore...');
      ...
      try {
        ...
        console.error('❌ Impossible de réactiver le réseau:', networkError);
      }
  ...
  async clearBrowserCache(): Promise<void> {
    try {
      ...
      console.error('❌ Erreur lors du nettoyage cache navigateur:', error);
    }
  }
  ...
  async autoRecover(): Promise<boolean> {
    try {
      ...
      console.log('✅ Pas de problème de cache détecté');
      return false;
    } catch (error) {
  ...
  async initializeRobustCache(): Promise<void> {
    try {
      console.log('🚀 Initialisation cache robuste...');
      ...
      console.log('✅ Cache initialisé en mode robuste');
    } catch (error) {
      console.error('❌ Erreur initialisation cache robuste:', error);
